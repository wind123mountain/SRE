...
# ==== Định nghĩa các biến ====
BASE_PATH=.
OUTPUT_DIR="${BASE_PATH}/outputs/test/seed-${SEED}"
CKPT_NAME="test-checkpoint"
...
OPTS+=" --n_encoder_finetuned 12"
OPTS+=" --hidden_loss_weights 1"

OPTS+=" --entropy_weight True"
OPTS+=" --student_layer_mapping 11 12"
...
OPTS+=" --student_model openai-community/gpt2"
